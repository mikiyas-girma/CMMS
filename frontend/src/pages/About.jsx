...
const About = () => {
    ...
    <HStack marginLeft='100px' marginRight='100px' marginBottom='50px' >
        ...
        <Card marginRight='100px' gap='300px'>
                        ...
                        <Text fontSize='20px' color='blueblack' as='b' marginLeft='450px'    > Our Commitment to Excellence</Text><br /><br />
                        <p class="mb-3 text-center text-gray-500 dark:text-gray-400">At the core of our Construction and Material Store Management System is a relentless commitment to excellence. We've assembled a team of industry experts, software engineers, and customer service professionals who are dedicated to delivering exceptional solutions and providing unparalleled support to our clients.</p>
                        <p class="mb-3 text-center text-gray-500 dark:text-gray-400">We understand the unique challenges faced by construction companies and material suppliers, and we've designed our system to address those challenges head-on. By continuously innovating and adapting to the evolving needs of the industry, we strive to be the trusted partner in your construction and material management journey.</p>
                        <p class="mb-3 text-center text-gray-500 dark:text-gray-400">We invite you to explore the capabilities of our Construction and Material Store Management System and discover how it can transform your business. Contact us today to learn more and schedule a personalized demonstration.</p>
  <br /><br />
               </div>
