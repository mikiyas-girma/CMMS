...
const Materials = () => {
    ...
    const [rowsToShow, setRowsToShow] = useState(materialList.slice(0, rowsLimit));
    ...
    const handleAddMaterial = () => {
        ...
        const materialIndex = materialList.findIndex((material) => material.Name === addMaterial);
        ...
        setRowsToShow([...materialList.slice(currentPage * rowsLimit, (currentPage + 1) * rowsLimit)]);
        setIsWithdrawOpen(false);
    };
    ...
    const handleWithdrawMaterial = () => {
        ...
        const materialIndex = materialList.findIndex((material) => material.Name === withdrawMaterial);
        const updatedMaterial = { ...materialList[materialIndex] };
